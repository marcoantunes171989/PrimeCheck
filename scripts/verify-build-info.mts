...
assert.match(bundle, /Mostrar NFC-e/)
assert.match(bundle, /Período de emissão/)
assert.match(bundle, /XML de origem/)
assert.match(bundle, /Chave de acesso/)
assert.match(bundle, /Menor que 8 dígitos/)
assert.match(bundle, /Maior que 8 dígitos/)
assert.match(bundle, /Processamento local/)
assert.match(bundle, /PrimeCheck não conseguiu iniciar/)
assert.match(bundle, /data-primecheck-runtime-error/)
