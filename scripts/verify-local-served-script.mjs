...
assert.match(launcher, /serverScript/)
assert.match(launcher, /serve-primecheck-local\.ps1/)
assert.match(launcher, /& \$serverScript/)

assert.match(finalServer, /\$Port = 4177/)
assert.match(finalServer, /node_modules\\vite\\bin\\vite\.js/)
assert.match(finalServer, /--host/)
assert.match(finalServer, /127\.0\.0\.1/)
assert.match(finalServer, /--port/)
assert.match(finalServer, /--strictPort/)
assert.match(finalServer, /PRIMECHECK_NO_OPEN/)
assert.match(finalServer, /--open/)
assert.match(finalServer, /& \$NodeCmd @viteArgs/)
